...
def test_delete(service_unit, get_empty_pcap):
    file = werkzeug.datastructures.FileStorage(stream=BytesIO(get_empty_pcap), content_type="application/vnd.tcpdump.pcap", filename="1.pcap")
